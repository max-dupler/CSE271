...
/**
 * A simple top-level class to test the operations of the 3 different
 * shapes. It also displays them using a pretty Graphical User Interface (GUI)
 * 
 * @author raodm
 *
 */
public class GeometricArt {
    ...
    /**
     * The main method creates a set of shapes and displays them using
     * an art display.
     * 
    ...
    /**
     * A simple method to test operations of the ShapeAnalyzer class, once
