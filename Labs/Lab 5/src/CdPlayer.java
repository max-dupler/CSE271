 ...
 * light bulb is a very simple device and implements just the Controllable int
 * erface.
 *
 */
public class CdPlayer implements RemoteControl {
     ...
     * simply prints that the CD player is on.
     */
    public void on() {
     ...
     * simply prints that the CD player is off.
     */
    public void off() {
