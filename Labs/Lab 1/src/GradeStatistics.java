...
public class GradeStatistics {
    ...
    /**
     * . Creates an array of grades from a file given by the user
     * 
     * @return an array containing grades in the file
    ...
    /**
     * . Prints the mean, minimun, and maximum values of a given array
     * 
     * @param mean   a double value of the mean
     * @param minMax an array of two doubles, the min and max
     */
